 ...
 * 
 * - O parâmetro '--save' na hora de instalar uma biblioteca externa salva aquela
 * biblioteca no arquivo 'package.json' como uma dependencia do projeto. O parâmetro
 * '--save-dev' tem o mesmo objetivo, mas indica que aquela biblioteca é uma dependência
 * apenas durante o desenvolvimento.
 * 
 * - O comando 'npm i axios@0.17.1 -E^' instalara exatamente a versão 0.17.1 do axios. O
 * parâmetro '-E' indica que deve ser sinalizado nas dependencias do projeto no arquivo
 ...
 * comando 'npm i' dentro do diretório onde desejamos instalá-los.
 * 
